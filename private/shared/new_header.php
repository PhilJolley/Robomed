<?php
 ...
 <html>
 <head>
   <title>Robomed Network</title>
   <meta charset="utf-8">
   <meta name="viewport" content="width=device-width, initial-scale=1">
   <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   <link rel="stylesheet" media="all" href="<?php echo url_for('/stylesheets/styles3.css'); ?>" />
           ...
           <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                   <ul id="text" class="nav navbar-nav navbar-right">
                       <li>
                           <a class="page-scroll" href="<?php echo url_for('/index.php'); ?>"><i id = "newUser" class="fa fa-user-plus"></i> Sign in</a>
                       </li>
                   </ul>
               </div>
               <!-- /.navbar-collapse -->
