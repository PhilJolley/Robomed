    ...
    <div class="row">
      <div class="col-md-2">
        <div class="list-group">
          ...
          <a href="/Robomed_Network/public/user/subjects/blog.php" class="list-group-item"><i id = "blogIcon" class="fa fa-pencil-square-o"></i> Write Blog Posts</a>
          <a href="/Robomed_Network/public/user/subjects/translate.php" class="list-group-item active main-color-bg"><i id = "translateIcon" class="fa  fa-file-text"></i> Translate</a>
